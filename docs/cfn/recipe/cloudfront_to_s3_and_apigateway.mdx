---
id: cloudfront_to_s3_and_apigateway
...
<img src="https://serverlessland.com/assets/images/patterns/cdk-cloudfront-to-s3-and-lambda.png" />
...
cd serverless-patterns/cdk-cloudfront-to-s3-and-lambda
```
